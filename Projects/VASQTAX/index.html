...
<head>
    ...
    <script src="https://kit.fontawesome.com/4cdb936a52.js"></script>
</head>
<body>
...
<nav>
    ...
    <ul>
        <a href="apply.html"><li>Apply To File!</li></a>
...
<main>
   <section class="hero">
      <div class="hero-left"><header class="hero-text">
           <h1 class="hero-title">Personal Tax Filings, <br>with experienced people.</h1>
            ...
            <div class="hero-p-container">
                ...
                <p class="hero-p"> <img  class="hero-portrait-p" src="/Projects/VASQTAX/imgs/portraitsquare.png" alt="Portrait of Mario Vasquez" align="right">We at Vasquez Services has been serving our clients for 20 years! Prioritizing in filing Tax Returns for the public, Vasquez Services was started from grassroots, popularied by word of mouth, and built by earning the trust of our clients. <br> Serving clients locally, as well as nationally, distance is not a problem with Mario as your Tax Expert, because with us, every tax filing has an individual behind it.</p>
            </div>
      </div>
      <div class="hero-right">
        <img  class="hero-portrait" src="/Projects/VASQTAX/imgs/portraitsquare.png" align="right" alt="Portrait of Mario Vasquez"> Mario Vasquez ~ Owner
      </div>
   ...
   <section id="about" class="about-us">
       ...
       <!-- <div class="abt-article1">
        ...
        <div class="abt-article2">
            ...
            <div><h3>Who we are</h3>
              <p>A family-run business, with Mario Vasquez as the head and Tax Expert, 
              Vasquez Services was opened for the first time in the year 2000, in the same location it is now! <br> <br> From that point, Vasquez Services has only grown, thanks to the trust of our communities, built over 20 years of dedicated service to help each individual get the highest possible value with their taxes.  </p> <br>
              
              <h3>Where we are</h3>
            <p style="text-align: center; text-indent: 0%; font-size: 22px; text-decoration: underline;"> <em> Vasquez Services is located at 620 Boston Street, Lynn MA 01905. </em></p>
            <br>
            <p>Next to the intersection of Boston st, and Laurel st./Myrtle st. Directly next to Family Corner Grocery II. If you went up the hill, you just passed it! <br> <br>
               Nearby landmarks include: &nbsp Sacred Heart Church, &nbsp Barry Park, &nbsp and &nbsp Lincoln Thompson School. </p>
            </div>
        </div>
   </section>
   ...
   <section  id="contact" class="contact-us">
      ...
      <p style="font-size: 24px;"> <u>Phone number: 781-599-8877</u> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  <u>Email: VasquezServices@pm.me</u> <br> <br></p>
      <p>Feel free to inquire with us, we respond to all messages during normal business hours. 
      <br> <br><em>Fields marked with an asterisk (*) are required</em></p>
